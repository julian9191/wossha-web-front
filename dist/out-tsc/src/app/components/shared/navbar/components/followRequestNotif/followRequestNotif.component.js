...
var refuseFollowCommand_1 = require("app/models/social/commands/refuseFollowCommand");
var FollowRequestNotifComponent = /** @class */ (function () {
    function FollowRequestNotifComponent(userService, socialService, notificationsService) {
    ...
    FollowRequestNotifComponent.prototype.refuse = function (notification) {
        this.refuseFollowCommand.username = this.user.username;
        this.refuseFollowCommand.senderUsername = notification.senderUserName;
        var nthis = this;
        this.notificationsService.showConfirmationAlert("¿Está seguro?", "¿Estás seguro de rechazar esta solicitud?", this.notificationsService.WARNING).then(function (response) {
            if (response) {
                nthis.socialService.executeCommand(nthis.refuseFollowCommand).subscribe(function (messaje) {
    ...
    ], FollowRequestNotifComponent.prototype, "notification", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", Object)
    ], FollowRequestNotifComponent.prototype, "notificationRemovedEvent", void 0);
    FollowRequestNotifComponent = __decorate([
        core_1.Component({
    ...
    return FollowRequestNotifComponent;
}());
exports.FollowRequestNotifComponent = FollowRequestNotifComponent;
//# sourceMappingURL=followRequestNotif.component.js.map