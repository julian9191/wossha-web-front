...
export const SESSION_STORAGE_KEY:string = "loginInfo";
...
export const PICTURES_PATH:string="http://localhost:8083/"; 
export const SOCIAL_PATH:string="http://localhost:8084/"; 